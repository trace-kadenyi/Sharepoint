...
export default class FaqWebPart extends BaseClientSideWebPart<IFaqWebPartProps> {
  ...
  // Validation function
  private validateListPicker(value: string): string | Promise<string> {
    // Example: Check if a value is selected
    if (!value) {
      return "Please select a list.";
    }
    // If validation passes, return empty string or resolve Promise with empty string
    return "";
  }
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyFieldListPicker("list", {
                  ...
                  onGetErrorMessage: this.validateListPicker.bind(this),
